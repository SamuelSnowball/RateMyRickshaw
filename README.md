...
- 🖼️ Image analysis using AWS Rekognition
- 🛺 Rickshaw detection with confidence scoring
- 🏷️ Object/label detection with confidence scores
- ⚡ Fast cold start times with Quarkus on Lambda
...
├── src/
│   └── main/
│       ├── java/com/ratemyrickshaw/
│       │   ├── lambda/
│       │   │   └── RickshawAnalysisHandler.java
│       │   ├── model/
